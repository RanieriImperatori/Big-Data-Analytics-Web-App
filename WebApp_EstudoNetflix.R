...
#Criando dataframes filtrando os outliers
dataset1_scat_out <- filter(dataset1, Country != "United States") #Números absurdos que fogem do padrão
dataset1_bar <- filter(dataset1, Country != "Switzerland") #Outlier - Desilgualdade social baixa
dataset1_bar_out <- filter(dataset1_bar, Country != "South Africa") #Outlier - Desigualdade social alta
